...
export function CastingDetailModal({ open, onOpenChange, entry }: Props) {
  ...
  function handleDelete() {
    startDelete(async () => {
      await softDeleteCastingEntry(entryId);
      ...
      >
        ...
        <div className="mt-6 -mx-6 -mb-6 px-6 py-4 border-t border-outline-variant flex items-center justify-between gap-3 flex-wrap">
          {/* Phase 22.1 — Delete (always-visible, not hover-reveal) so a
              ...
              casting entry. Two-step confirm mirrors the desktop row. */}
          {confirmingDelete ? (
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                disabled={isDeleting}
                data-testid={`modal-confirm-delete-casting-${entryId}`}
            ...
            <button
              ...
              data-testid={`modal-delete-casting-${entryId}`}
