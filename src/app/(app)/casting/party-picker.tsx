...
// Vendor picker for casting/plating entries. Mirrors the Sales/Purchases
  ...
  return (
    <div ref={containerRef} className="space-y-3">
      <div className="relative">
        <FormLabel htmlFor="casting-party-name" required>
          Vendor
        </FormLabel>
        <FormInput
          id="casting-party-name"
          type="text"
          autoComplete="off"
          value={query}
          onChange={(e) => {
      ...
      <div>
        <FormLabel htmlFor="casting-party-phone">Phone</FormLabel>
        <FormInput
          id="casting-party-phone"
          type="tel"
          autoComplete="off"
          value={phoneInput}
          onChange={(e) => {
